...
if (isset($_POST['pdf'])) {
    include 'pdfpistas.php';
}
if (isset($_POST['excel'])) {
    include 'excel/excelpistas.php';
}
?>
<!DOCTYPE html>
<html lang="es">
...
mostrarNavbar();
if (isset($_POST['alta']) || isset($_POST['baja']) || isset($_POST['modificacion']) || isset($_GET['borrar']) || isset($_POST['individual']) || isset($_POST['masiva']) || isset($_POST['insertarmasiva']) || isset($_GET['modificar']) || isset($_POST['pdf']) || isset($_POST['validar']) || isset($_POST['altapistaindi'])) {
    if (isset($_POST['alta'])) { ?>
        ...
        <div class="col-md-12 col-12 formulario mb-2">
            ...
            <form action="" method="post" id="miFormulario" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="empresaPista">Empresa Pista</label>
                            <select class="form-select" id="empresapista" name="empresapista" title="Empresa Pista" required>
                ...
                <div class="text-center">
                    ...
                    <a href="gestionpistas.php"><button type="button" id="volver" name="volver" class="btn botonancho btn-lg btn-block  ms-2 mt-4">Volver</button></a>
                </div>
            </form>
        </div>
    ...
    if (isset($_POST['insertarmasiva'])) {
        ...
        <?
                ...
                if (isset($_POST['baja'])) {
                    include 'NOACCESIBLE/credencialesdb.php';
                    $c1 = new mysqli($host, $usuario, $contraseña, 'PistasDelgadoR');
                    $stmt = mysqli_prepare($c1, "SELECT id_pista,tipo_pista,nombre_pista,provincia,municipio,telefono_contacto,precio_hora,fecha_registro FROM pistas");
                    $stmt->execute();
                    mysqli_stmt_bind_result($stmt, $rid, $rtipo, $rnombre, $rprovincia, $rmunicipio, $rtelefono, $rprecio, $rfecha);
        ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <th>
                                    <div class="text-center">
                                        <a href="gestionpistas.php?borrar=borrar&idpista=<?php echo urlencode($rid); ?>">
        ...
        <div class="text-center">
            <a href="gestionpistas.php"><button type="submit" id="volver" name="volver" class="btn botonancho btn-lg btn-block mb-2  ms-2">Volver</button></a>
        </div>
        ...
        <?
                ...
                if (isset($_POST['modificacion'])) {
                    include 'NOACCESIBLE/credencialesdb.php';
                    $c1 = new mysqli($host, $usuario, $contraseña, 'PistasDelgadoR');
                    $stmt = mysqli_prepare($c1, "SELECT id_pista,tipo_pista,nombre_pista,comunidad_autonoma,provincia,municipio,codigo_postal,correo_contacto,telefono_contacto,precio_hora,fecha_registro FROM pistas");
                    $stmt->execute();
                    mysqli_stmt_bind_result($stmt, $rid, $rtipo, $rnombre, $rcomunidad, $rprovincia, $rmunicipio, $rcp, $rcorreo, $rtelefono, $rprecio, $rfecha);
        ?>
        <div class="table-responsive mt-3">
            <div class="col-md-12">
                <table class="table table-striped table-hover table-bordered display" id="example">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <form action="gestionpistas.php" method="get">
                                    <th>
                                        <? echo $rid ?>
                                    </th>
                                    <th>
    <label for="rtipopista_<?php echo $rid; ?>" aria-label="Tipo de pista" class="visually-hidden">Tipo de pista</label>
    <input type="text" name="rtipopista" id="rtipopista_<?php echo $rid; ?>" value="<? echo $rtipo ?>" required>
</th>
<th>
    <label for="rnombre_<?php echo $rid; ?>" aria-label="Nombre" class="visually-hidden">Nombre</label>
    <input type="text" name="rnombre" id="rnombre_<?php echo $rid; ?>" value="<?php echo $rnombre; ?>" required>
    <div style="display: none;">
        <?php echo $rnombre; ?>
    </div>
</th>
<th>
    <label for="rcomunidad_<?php echo $rid; ?>" aria-label="Comunidad" class="visually-hidden">Comunidad</label>
    <input type="text" name="rcomunidad" id="rcomunidad_<?php echo $rid; ?>" value="<? echo $rcomunidad ?>" required>
</th>
<th>
    <label for="rprovincia_<?php echo $rid; ?>" aria-label="Provincia" class="visually-hidden">Provincia</label>
    <input type="text" name="rprovincia" id="rprovincia_<?php echo $rid; ?>" value="<? echo $rprovincia ?>" required>
</th>
<th>
    <label for="rmunicipio_<?php echo $rid; ?>" aria-label="Municipio" class="visually-hidden">Municipio</label>
    <input type="text" name="rmunicipio" id="rmunicipio_<?php echo $rid; ?>" value="<? echo $rmunicipio ?>" required>
</th>
<th>
    <label for="rcp_<?php echo $rid; ?>" aria-label="Código Postal" class="visually-hidden">Código Postal</label>
    <input type="text" name="rcp" id="rcp_<?php echo $rid; ?>" value="<? echo $rcp ?>" required>
</th>
<th>
    <label for="rcorreo_<?php echo $rid; ?>" aria-label="Correo" class="visually-hidden">Correo</label>
    <input type="text" name="rcorreo" id="rcorreo_<?php echo $rid; ?>" value="<? echo $rcorreo ?>" required>
</th>
<th>
    <label for="rtelefono_<?php echo $rid; ?>" aria-label="Teléfono" class="visually-hidden">Teléfono</label>
    <input type="text" name="rtelefono" id="rtelefono_<?php echo $rid; ?>" value="<? echo $rtelefono ?>" required>
</th>
<th>
    <label for="rprecio_<?php echo $rid; ?>" aria-label="Precio" class="visually-hidden">Precio</label>
...
<th>
    <? echo date("d-m-Y", strtotime($rfecha)) ?>
                                    ...
                                    <input type="hidden" name="ridpista" value="<? echo $rid ?>">
                                    <input type="hidden" name="rfechapista" value="<? echo $rfecha ?>">
        ...
        <?
                ...
                if (isset($_GET['modificar'])) {
                    $idpista = $_GET['ridpista'];
                    $fechapista = $_GET['rfechapista'];
                    $nombrepista = $_GET['rnombre'];
                    $tipopista = $_GET['rtipopista'];
                    $comunidad = $_GET['rcomunidad'];
                    $provincia = $_GET['rprovincia'];
                    $municipio = $_GET['rmunicipio'];
                    $cp = $_GET['rcp'];
                    $correo = $_GET['rcorreo'];
                    ...
                    include 'NOACCESIBLE/credencialesdb.php';
                    $c1 = new mysqli($host, $usuario, $contraseña, 'PistasDelgadoR');
                    $stmt = mysqli_prepare($c1, "UPDATE pistas SET tipo_pista=?,nombre_pista=?,comunidad_autonoma=?,provincia=?,municipio=?,codigo_postal=?,correo_contacto=?,telefono_contacto=?,precio_hora=? WHERE id_pista=?");
                    mysqli_stmt_bind_param($stmt, "ssssssssss", $tipopista, $nombrepista, $comunidad, $provincia, $municipio, $cp, $correo, $telefono, $precio, $idpista);
                    if ($stmt->execute()) {
        ?>
            <section class="vh-100">
                <div class="container py-5 h-100">
    ...
    <?
                ...
                if (isset($_POST['validar'])) {
                    header("Location: validarimagenes.php");
                }
            } else {
    ?>
    <form method="post" action="">
                        ...
                        <div class="col col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="card shadow-2-strong" style="border-radius: 1rem;">
                                <div class="card-body p-5 text-center" id="carta">
                                    ...
                                    <button class="btn botonancho btn-lg btn-block ms-2" name="validar" type="submit">Validar</button>
